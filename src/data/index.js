  ...
  experience: [ 
    {
      ...
      desc: 'Worked on real-world full-stack projects using React, Node.js, and MongoDB. Contributed to frontend UI components and backend API endpoints with modern development workflows.',
    },
    {
      icon: 'E',
      date: '2023 - Present',
